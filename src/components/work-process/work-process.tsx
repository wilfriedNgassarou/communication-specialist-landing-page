...
export function WorkProcess() {
  return (
    <>
      ...
      <section className="px-5 lg:px-20 h-auto lg:h-dvh w-full flex flex-col gap-y-14 lg:flex-row lg:items-center bg-gray-200/60">
        ...
        <section className="w-full lg:w-1/2 grid grid-cols-1 lg:grid-cols-2 gap-4">
          {workProcess.map((item, index) => (
            ...
            >
              <div>
                <div className="flex justify-center items-center w-16 h-16 rounded-lg transition-colors duration-300 bg-[#EDD8FF] bg-opacity-50 group-hover:bg-primary group-hover:bg-opacity-100">
